...
VfdMeterは、WindowsのCPU使用率とメモリ使用率を小型のVFD風オーバーレイで表示する、.NET 10 WinForms常駐アプリです。

## 現在の機能

- `CPU 023% MEM 048%` 形式でCPU・メモリ使用率を表示
- 1秒ごとに表示を更新
...
NETおよびDSKメーターは未実装です。ネットワーク通信は行いません。また、管理者権限は必要ありません。
